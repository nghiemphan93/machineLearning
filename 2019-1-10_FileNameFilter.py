...
for fileName in fileNames:
   ...
   toRemoveList = ["[Tutsgalaxy.com] - ", "_freetuts.download_ Udemy - ", "_freetuts.download_ Udemy - ", "_freetuts.download_Udemy - ", "OReilly.", "Apress.", "CreateSpace.", "Manning.", "No.Starch.Press.Malware.", "Packt.",
